...
| v12 | `rain-education-website-v12-transparent-copy-20260612.zip` | Latest version. Hero and cinematic text layers made transparent while keeping readable text shadows. |

## Latest Version

Use `website-versions/archives/rain-education-website-v12-transparent-copy-20260612.zip` for the latest deployable package.

Key latest previews:

- `website-versions/previews/rain-v12-transparent-hero.png`
- `website-versions/previews/rain-v12-transparent-campus.png`
- `website-versions/previews/rain-v12-transparent-hong-kong.png`
- `website-versions/previews/rain-v12-transparent-mobile.png`
...
The v12 package uses the cache-busting asset version:

- `styles.css?v=20260612-v12-transparent-copy`
- `script.js?v=20260612-v12-transparent-copy`
